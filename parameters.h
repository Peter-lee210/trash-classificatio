...
const int bn_scale_layer = tile_conv_out; // Number of output channels for scaling
const int bn_shift_layer = tile_conv_out; // Number of output channels for shifting
